...
(function($) {
    ...
    $.fn.filer.defaults = {
        ...
        captions: {
            button: "Choisissez un fichier",
            feedback: "Pas de fichier choisi",
            feedback2: "fichier(s) choisi(s)",
            drop: "Glissez le fichier ici",
            removeConfirmation: "Etes vous sûr de vouloir supprimer ce fichier ?",
            errors: {
                filesLimit: "La limite de fichiers est de {{fi-limit}} images",
                filesType: "Vous ne pouvez télécharger que des images",
                filesSize: "{{fi-name}} est trop lourd, la limite est de {{fi-fileMaxSize}} MB.",
                filesSizeAll: "Le fichier dépasse la limite de {{fi-maxSize}} MB.",
                folderUpload: "Vous n'êtes pas authorisé à envoyer un fichier"
            }
        }
    }
})(jQuery);
