 ...
 */
final class Version20211014101411 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE wishlist_search (id INT AUTO_INCREMENT NOT NULL, id_compte_id INT NOT NULL, INDEX IDX_7C204E172F0DA07 (id_compte_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
