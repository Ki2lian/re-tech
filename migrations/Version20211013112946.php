 ...
 */
final class Version20211013112946 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD nom VARCHAR(255) DEFAULT NULL, ADD prenom VARCHAR(255) DEFAULT NULL, ADD pseudo VARCHAR(255) NOT NULL, ADD actif TINYINT(1) NOT NULL, ADD date_creation DATETIME NOT NULL, ADD date_modification DATETIME NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `user` DROP nom, DROP prenom, DROP pseudo, DROP actif, DROP date_creation, DROP date_modification');
    }
}
