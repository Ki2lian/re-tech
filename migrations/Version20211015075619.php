 ...
 */
final class Version20211015075619 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE wishlist_search_user (wishlist_search_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_970A0B83DF671938 (wishlist_search_id), INDEX IDX_970A0B83A76ED395 (user_id), PRIMARY KEY(wishlist_search_id, user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE wishlist_search ADD id_compte_id INT NOT NULL');
